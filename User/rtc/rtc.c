...
/*，星期，生肖用文字ASCII码*/
char const *WEEK_STR[] = { "星期天","星期一", "星期二", "星期三", "星期四", "星期五", "星期六"};
...
void Time_Display(uint32_t TimeVar,struct rtc_time *tm)
{
	   ...
	   to_tm(BJ_TimeVar, tm);/*把定时器的值转换为北京时间*/	
		...
		//时间
		sprintf((char *)str," 时间:  %0.2d:%0.2d:%0.2d",
																						tm->tm_hour, 									
																						tm->tm_min, 
																						tm->tm_sec);
		
		ILI9341_DispStringLine_EN_CH(LINE(4),(char*)str);
//#endif
